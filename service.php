...
$sql="SELECT b.BookingID,b.serviceName,b.price,a.ServiceID from bookingservice as a left join servicepackage as b on a.ServiceID = b.BookingID where a.customerID ='$username'";
    ...
    $servicetime = $_POST['servicetime'];
      ...
      if(empty($_REQUEST['item'])){
          ...
          foreach ($_REQUEST['item'] as $ServiceID){
            $sql = "INSERT into bookingservice(ServiceID,dateAdd,dateEnd,customerID,location,servicetime) values ('$ServiceID','$dateAdd','$dateAdd','$username','$location','$servicetime')";
